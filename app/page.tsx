  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-canvas">
        {/* Sidebar */}
        <div className="hidden md:flex md:w-[260px] md:flex-col bg-sidebar">
        <div className="flex h-full min-h-0 flex-col">
          <div className="flex h-full min-h-0 flex-col">
            <div className="p-4">
              <button className="mb-2 flex w-full items-center justify-center gap-3 rounded-md border border-white border-opacity-20 p-3 text-sm text-white transition-colors hover:bg-white/10">
